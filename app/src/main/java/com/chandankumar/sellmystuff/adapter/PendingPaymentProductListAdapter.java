...
public class PendingPaymentProductListAdapter extends RecyclerView.Adapter<PendingPaymentProductListAdapter.ViewHolder> {

    private Context mContext;
    private List<Product> mProductList;


    public PendingPaymentProductListAdapter(Context mContext, List<Product> mProductList) {
            ...
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        Intent intent = new Intent(mContext, PendingPaymentProductItemActivity.class);
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Utils.showLongMessage(mContext, "Error: "+ error.getMessage());
                }
            });
